...
byId('deleteRowBtn').addEventListener('click', async () => {
  ...
  try {
    ...
    logActivity({ action: 'delete', page: 'congTachMui', detail: `Xóa ${selectedRows.length} dòng Năng xuất tách múi` });
